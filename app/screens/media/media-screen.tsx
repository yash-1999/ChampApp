...
export const MediaScreen = observer(function MediaScreen() {
  ...
  console.tron.log("parentId media", parent_Id);
  ...
  // useEffect(() => {
  //   if(catagoryData.subCatagory.length > 0){
  ...
  //   console.tron.log("parentMedia",parentMediaCatagoryObj)
  ...
  // }, [catagoryData.subCatagory.length])
